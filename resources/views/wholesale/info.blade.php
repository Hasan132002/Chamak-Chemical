...
@section('content')
    <div class="bg-gradient-to-r from-secondary-500 to-orange-600 text-white py-20">
        <div class="container mx-auto px-4 text-center">
            <div class="text-7xl mb-6"><i class="fas fa-warehouse"></i></div>
            <h1 class="text-6xl font-extrabold mb-6">{{ __('Wholesale Program') }}</h1>
            <p class="text-2xl text-orange-100 max-w-2xl mx-auto mb-8">{{ __('Special pricing for bulk orders. Join our dealer network today!') }}</p>
            <a href="{{ route('wholesale.register') }}" class="inline-block bg-white text-secondary-500 hover:bg-gray-100 font-bold py-4 px-10 rounded-full text-lg transition shadow-2xl">
    ...
    <div class="container mx-auto px-4 py-16">
        <!-- Benefits -->
        <h2 class="text-4xl font-extrabold text-center mb-12 bg-gradient-to-r from-primary-500 to-blue-600 bg-clip-text text-transparent">
            {{ __('Wholesale Benefits') }}
        </h2>

        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            <div class="bg-white rounded-2xl p-8 text-center hover-lift shadow-lg">
        ...
        <!-- CTA -->
        <div class="text-center bg-gradient-to-r from-primary-500 to-blue-600 rounded-2xl p-12 text-white">
            <h2 class="text-3xl font-bold mb-4">{{ __('Ready to Get Started?') }}</h2>
            <p class="text-xl mb-8 text-blue-100">{{ __('Register now and start saving on bulk orders') }}</p>
