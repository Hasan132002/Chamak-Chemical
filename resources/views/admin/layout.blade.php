...
<body class="bg-gray-50">
    <div class="flex h-screen overflow-hidden">
        <!-- Sidebar -->
        <aside class="w-64 flex-shrink-0 hidden md:block" style="background: linear-gradient(180deg, #1e3a8a 0%, #1e40af 100%);">
            <div class="p-6 h-full flex flex-col">
                ...
                <nav class="space-y-2 flex-1">
                    ...
                    <a href="{{ route('admin.settings') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg text-white {{ request()->routeIs('admin.settings') ? 'bg-white/20' : 'hover:bg-white/10' }} transition">
        ...
        <main class="flex-1 overflow-y-auto">
            ...
            <header class="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-10">
                <div class="px-8 py-4 flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-sm text-gray-600">@yield('page-description', 'Manage your e-commerce platform')</p>
                    </div>
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 rounded-full flex items-center justify-center text-white font-bold" style="background: linear-gradient(135deg, #1e3a8a 0%, #3b82f6 100%);">
            ...
            <div class="p-8">
                ...
                @if(session('success'))
                    <div class="bg-green-100 border-l-4 border-green-500 text-green-700 px-6 py-4 rounded-lg mb-6 animate__animated animate__fadeIn">
