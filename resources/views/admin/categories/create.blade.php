...
<div class="max-w-4xl animate-slide-in">
    ...
    <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl shadow-lg p-8">
        @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="slug" value="{{ old('slug') }}" required
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent @error('slug') border-red-500 @enderror">
                    <p class="text-xs text-gray-500 mt-1">URL-friendly name (e.g., washing-powder)</p>
                    @error('slug')
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="description_ur" rows="3" dir="rtl"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('description_ur') }}</textarea>
                </div>
            </div>
        </div>
