...
<div class="animate-slide-in">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 hover-lift" style="border-left: 4px solid #10b981;">
            <div class="flex items-center justify-between mb-4">
                <div>
                    <p class="text-sm text-gray-600 font-semibold mb-1">Today's Sales</p>
                    <h3 class="text-3xl font-bold text-green-600">PKR {{ number_format($todaySales, 0) }}</h3>
                </div>
            ...
            <p class="text-xs text-gray-500"><i class="fas fa-arrow-up text-green-500 mr-1"></i>Updated today</p>
        </div>

        <div class="bg-white rounded-2xl shadow-lg p-6 hover-lift" style="border-left: 4px solid #3b82f6;">
            <div class="flex items-center justify-between mb-4">
                <div>
                    <p class="text-sm text-gray-600 font-semibold mb-1">This Month</p>
                    <h3 class="text-3xl font-bold text-blue-600">PKR {{ number_format($monthSales, 0) }}</h3>
                </div>
            ...
            <p class="text-xs text-gray-500"><i class="fas fa-chart-line text-blue-500 mr-1"></i>Monthly total</p>
        </div>

        <div class="bg-white rounded-2xl shadow-lg p-6 hover-lift" style="border-left: 4px solid #a855f7;">
            <div class="flex items-center justify-between mb-4">
                <div>
                    <p class="text-sm text-gray-600 font-semibold mb-1">Total Revenue</p>
                    <h3 class="text-3xl font-bold text-purple-600">PKR {{ number_format($totalRevenue, 0) }}</h3>
                </div>
            ...
            <p class="text-xs text-gray-500"><i class="fas fa-infinity text-purple-500 mr-1"></i>All time</p>
        </div>

        <div class="bg-white rounded-2xl shadow-lg p-6 hover-lift" style="border-left: 4px solid #f59e0b;">
            <div class="flex items-center justify-between mb-4">
                <div>
                    <p class="text-sm text-gray-600 font-semibold mb-1">Avg Order Value</p>
                    <h3 class="text-3xl font-bold text-orange-600">PKR {{ number_format($avgOrderValue, 0) }}</h3>
                </div>
            ...
            <p class="text-xs text-gray-500"><i class="fas fa-chart-bar text-orange-500 mr-1"></i>Average value</p>
        </div>
    </div>
